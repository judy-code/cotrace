// 台灣 22 縣市＋所轄 368 個鄉鎮市區，資料來源：內政部國土測繪中心官方 API
// （https://api.nlsc.gov.tw/other/ListCounty、ListTown1/{縣市代碼}），逐縣市查詢後彙整。
// 縣市／行政區名稱一律使用「台」而非「臺」，與專案既有範例資料（talentPool.js）用字一致。
export const TAIWAN_DISTRICTS = [
  ...
  },
  {
    city: '苗栗縣',
    districts: [
      '苗栗市', '苑裡鎮', '通霄鎮', '竹南鎮', '頭份市', '後龍鎮', '卓蘭鎮', '大湖鄉', '公館鄉', '銅鑼鄉',
  ...
  },
  {
    city: '彰化縣',
    districts: [
      '彰化市', '鹿港鎮', '和美鎮', '線西鄉', '伸港鄉', '福興鄉', '秀水鄉', '花壇鄉', '芬園鄉', '員林市',
      '溪湖鎮', '田中鎮', '大村鄉', '埔鹽鄉', '埔心鄉', '永靖鄉', '社頭鄉', '二水鄉', '北斗鎮', '二林鎮',
  ...
  },
  {
    ...
    districts: [
      ...
      '二崙鄉', '崙背鄉', '麥寮鄉', '東勢鄉', '褒忠鄉', '台西鄉', '元長鄉', '四湖鄉', '口湖鄉', '水林鄉',
    ],
  },
  {
    city: '嘉義縣',
    districts: [
      ...
      '鹿草鄉', '水上鄉', '中埔鄉', '竹崗鄉', '梅山鄉', '番路鄉', '大埔鄉', '阿里山鄉',
    ],
  },
  {
    city: '屏東縣',
...
export const OVERSEAS_LOCATION = '國外'
